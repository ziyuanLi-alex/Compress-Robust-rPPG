...
def main():
    parser = argparse.ArgumentParser(description='Visualize PURE PhysMamba on UBFC-rPPG vs UBFC-Phys')
    parser.add_argument('ubfc_rppg_csv', type=str, help='Path to PURE PhysMamba UBFC-rPPG results CSV')
    parser.add_argument('ubfc_phys_csv', type=str, help='Path to PURE PhysMamba UBFC-Phys results CSV')
    ...
    # Dataset colors - UBFC-rPPG: orange, UBFC-Phys: brown
    dataset_colors = {
        'UBFC-rPPG': '#ff7f0e',     # orange
        'UBFC-Phys': '#8c564b'      # brown
    }
    ...
    for metric_idx, metric in enumerate(args.metrics):
        ...
        output_path = output_dir / f'UBFC_rPPG_Phys_PhysMamba_{metric}.png'
